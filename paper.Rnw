...
Breastfeeding duration is measured in weeks. The study tracks the following factors: race (white, black, other), poverty, somking, drinks alcohol, age of mother, mother's year of birth, mother's education level, and if the mother has prenatal car after the 3rd month of pregnancy.
